...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="561" id="AutoNumber7" height="51">
  ...
  <tr>
    <td width="97" height="13">Date Of Birth</td>
...
<SELECT name=sex size=1 tabIndex=7> <OPTION 
    ...
    <td width="116" height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Passport 
    No </td>
    <td width="179" height="25"><FONT color=#004080>
  ...
  <tr>
    <td width="559" colspan="4" height="27">Hobbies&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea id="hobbies" name="hobbies" style="HEIGHT: 40px; WIDTH: 160px" rows="1" cols="20" tabIndex=10>
</textarea></td>
  </tr>
  <tr>
  ...
  <tr>
  <td width="97">
    <td width="279" colspan="2" height="33">Permanent Address</td>
    <td width="179" height="33">Current Address</td>
  </tr>
  <tr>
    <td width="97" height="27">
      <p align="left">&nbsp;Street Name</p>
    </td>
    <td width="161" height="27"><FONT color=#004080>
    <INPUT name="p_streetname" tabIndex=11 size="16"></FONT></td>
    <td width="116" height="27">&nbsp; Street Name</td>
    <td width="179" height="27"><FONT color=#004080>
...
<div align="center">
  ...
  <table border="0" width="100%" cellpadding="0" cellspacing="0" height="204">
    ...
    <tr>
      <td width="41%" height="43">Skills&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <tr>
      <td width="41%" height="35">Experience&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
color=#ae0000>
    ...
    2001<OPTION value=2002>2002<OPTION value=2003>2003<OPTION value=2004>2004<OPTION value=2005>2005<OPTION value=2006>2006 </OPTION></SELECT></p>
    </TD>
...
color=#ae0000><SELECT 
      name="i_year" size=1 tabIndex=29> <OPTION selected 
        value="">-Year-<OPTION value=1990>1990<OPTION value=1991>1991<OPTION value=1992>1992<OPTION value=1993>1993<OPTION value=1994>
    1994<OPTION value=1995>1995<OPTION value=1996>1996<OPTION value=1997>1997<OPTION value=1998>1998<OPTION value=1999>1999<OPTION value=2000>2000<OPTION value="2001">
    2001<OPTION value=2002>2002<OPTION value=2003>2003<OPTION value=2004>2004<OPTION value=2005>2005<OPTION value=2006>2006</OPTION></SELECT></FONT></p>
    </TD>
    <TD height="23" width="72">
    <p align="center">
